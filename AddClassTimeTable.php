                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-12 col-lg-12 col-12 aj-mb-2">
                                                ...
                                                <div class="form-group aj-form-group">
                                                    ...
                                                    <input type="file" name="class-routine" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>                                       
                                    ...
                                    <div class="Attendance-staff mt-5 aj-scroll-Attendance-staff">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
												...
												?>
                                                    <tr>
                                                        <td style="text-align: center; width:10%;"><a href="#<?php echo $row["Class_Routine_Id"]; ?>"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a></td>
                                                        <td><?php echo $row["Class_Name"]; ?></td>
                                                        <td><?php echo $rowdept["Section"]; ?></td>
                                                        <td><?php echo $rowdept["Staff_Name"]; ?></td>
                                                        <td><?php echo ""; ?></td>
                                                    </tr>
                                                 <?php } ?>  
                                                </tbody>                                                
