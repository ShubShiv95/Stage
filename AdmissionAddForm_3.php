<?php
    ...
    $updateAdmissionTableSql = "update admission_master_table set School_Id = '" . $schoolId . "', Session ='". $session . "', First_Name = '". $studentFirstName ."' , Middle_Name = '" . $studentMiddleName . "', Last_Name ='". $studentLastName . "', Class_Id ='". $studClass . "'  Gender = '" . $studentGender . "', DOB = '" . $studntDOB .'", Age = "' . $studentAge . "', Social_Category = '" . $studentSocialCat . "', Discount_Category = '" . $studDiscCat . "', Locality = '" . $studLocality ."',
        Academic_Session = '" . $studAcademicSession . "', Mother_Tongue = '" . $studMotherTongue ."', Religion = '" . $studReligion ."', Nationality = '" . $studNationality . "', Blood_Group = '" . $studBloodGroup . "', Aadhar_No = '" . $studAdharCardNo . "', Prev_School_Name = '" . $studPrevSchoolName . "', Prev_School_Medium = '" . $studMOI . "', Prev_School_Board = '" . $studBoard ."', 
        Prev_School_Class = '" . $studClass ."', Comm_Address = '" . $commAddress . "', Comm_Add_Country = '" . $commCountry . "' , Comm_Add_State = '" . $commState . "', Comm_Add_City_Dist = '" . $commCityDist . "', Comm_Add_Pincode = '" . $commPinCode . "' , Comm_Add_ContactNo = '" . $commContactNo . "', Resid_Address = '" . $raAddress . "', Resid_Add_Country = '" . $raCountry . "',
        Resid_Add_State = '" . $raState . "', Resid_Add_City_Dist = '" . $raCityDist . "', Resid_Add_Pincode = '" . $raPinCode ."', Resid_Add_ContactNo = '" . $raContactNo . "', Sibling_1_Student_Id = '" . $sibling1StudId . "', Sibling_1_Class = '" . $sibling1Class ."', Sibling_1_Section = '" . $sibling1Section ."', Sibling_1_RollNo = '" . $sibling1RollNo ."', 
        Sibling_2_Student_Id = '". $sibling2StudId ."', Sibling_2_Class = '" . $sibling2Class ."', Sibling_2_Section = '" . $sibling2Section ."', Sibling_2_RollNo = '" . $sibling2RollNo ."', Father_Name = '" . $fatherName . "', Father_Qualification = '" . $fatherQual . "', Father_Occupation = '" . $fatherOccupation . "', Father_Designation = '" . $fatherDesig . "',
        Father_Org_Name = '" .$fatherOrgName . "', Father_Org_Add = '" . $fatherOrgAdd ."', Father_City = '" . $Father_State . "', Father_Country = '". $fatherCountry . "', Father_Pincode ='". $fatherPinCode . "', Father_Email = '" . $fatherEmail . "' , Father_Contact_No ='" . $fatherContactNo . "', Father_Annual_Income = '" . $fatherAnnualIncome . "', Father_Aadhar_Card = '" . $fatherAdharCardNo . "', Father_Alumni = '" . $fatherAlumni . "',
        Mother_Name = '" . $motherName . "', Mother_Qualification = '" . $motherQual ."', Mother_Occupation = '" . $motherOccupation . "', Mother_Designation = '" . $motherDesig . "', Mother_Org_Name = '" . $motherOrgName . "', Mother_Org_Add = '" . $motherOrgAdd . "', Mother_City = '" . $motherCity . "' , Mother_State '" . $motherState . "', Mother_Country = '" . $motherCountry . "', Mother_Pincode = '" . $motherPinCode . "', Mother_Email = '" . $motherEmail . "',
        Mother_Contact_No = '". $motherContactNo . "' , Mother_Annual_Income = '" . $motherAnnualIncome . "', Mother_Aadhar_Card = '" . $motherAdharCardNo . "' , Mother_Alumni = '" . $motherAlumni . "', Guardian_Address = '" . $othersAddress . "', Guardian_Name = '" . $othersName . "', Guardian_Relation = '" .$othersRelation . '", Guardian_Contact_No = "' . $othersMobileNo . "'
        SMS_Contact_No = '" . $studSMSContactNo . "', Whatsapp_Contact_No = '" . $studWhatsAppContactNo . "', Email_Id = '" . $studEmailAddress . "',
        Doc_Upload_1 ='". $docUpload_1 ."', Doc_Upload_2 ='" . $docUpload_2 . "', Doc_Upload_3 = '" . $docUpload_3 . "', Doc_Upload_4 = '" . $docUpload_4 . "', Doc_Upload_5 = '" . $docUpload_5 . "', Doc_Upload_6 = '" . $docUpload_6 . "', Doc_Upload_7 = '" . $docUpload_7 . "', Doc_Upload_8 = '" . $docUpload_8 . "'
