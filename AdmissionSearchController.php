<?php
    ...
    $selectAdmissionSql = "Select First_Name, Last_Name, Gender, DOB, Father_Name, Mother_Name, Guardian_Name From admission_master_table Where Class_Id = ? and Session = ?";
...
while ($row = $result->fetch_assoc()) {
      ...
      $htmlbody = $htmlbody . '<td>' . '<a href="" > Edit </a>'  . '/' . '<a href=""> View </a>' . '</td>';
      $htmlbody = $htmlbody . '</tr>';
