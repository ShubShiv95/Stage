            ...
            <div class="col-xl-4 col-lg-4 col-12 aj-mb-2">
                ...
                <div class="form-group aj-form-group">
                    ...
                    <select class="select2 col-12" name="studentGender" id="studentGender" required="">
                        ...
                        <option value="MALE" <?php if ($row["Gender"] == 'MALE') echo 'selected="selected"';
                                                else echo ''; ?>>Male</option>
                        <option value="FEMALE" <?php if ($row["Gender"] == 'FEMALE') echo 'selected="selected"';
                                                else echo ''; ?>>Female</option>
                        <option value="OTHER" <?php if ($row["Gender"] == 'OTHER') echo 'selected="selected"';
            ...
            <div class="col-xl-4 col-lg-4 col-12 ">
                ...
                <div class="form-group aj-form-group">
                    ...
                    <select class="select2 col-12" required="" name="studNationality" id="studNationality">
                        ...
                        <option value="INDIAN" <?php if ($row["Nationality"] == 'INDIAN') echo 'selected="selected"';
                                                else echo ''; ?>>Indian</option>
                        <option value="OTHERS" <?php if ($row["Nationality"] == 'OTHERS') echo 'selected="selected"';
