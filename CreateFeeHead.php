...
<head>
    ...
    <style type="text/css">
        .new-added-form.aj-new-added-form .popper-top {
        font-size: 13px;
        line-height: 13px;
        position: relative;
        top: -15px;
                                ...
                                <div class="col-xl-8 col-lg-8 col-12 aj-mb-2">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-5 col-lg-5 col-12 aj-mb-2">
                                            ...
                                            <p class="popper-top">Example: Tuetion Fee or Addmission Fee or Computer Fee,etc</p>
                                        ...
                                        <div class="col-xl-5 col-lg-5 col-12 aj-mb-2">
                                            <div class="form-group aj-form-group">
                                                ...
                                                <select class="select2" name="f_class">
                                                    ...
                                                    <option value="">Tuetion Fee</option>
                                                    <option value="">Computer Fee</option>
                                                    <option value="">Biology Lab Fee</option>
                                                    <option value="">Physics Lab Fee</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-12 aj-mb-2">
                                             ...
                                             <div class="tebal-promotion mt-0" >
