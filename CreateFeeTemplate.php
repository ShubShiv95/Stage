                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-8 col-lg-8 col-12 aj-mb-2">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-6 col-12 aj-mb-2 mb-4">
                                            <div class="form-group aj-form-group">
                                                ...
                                                <select class="select2" name="Fee-name">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-6 col-12 aj-mb-2 mb-4">
                                            <div class="form-group aj-form-group">
                                                ...
                                                <select class="select2" name="">
                                                    ...
                                                    <option value="">second Time Fee</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-12 aj-mb-2 mb-4">
                                            <div class="form-group aj-form-group">
                                                <label>Select Fee Mode</label>
                                                <select class="select2" name="">
                                                    <option value="">Mandatory</option>
                                                    <option value="">None Mandatory</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-12 aj-mb-2">
                                            ...
                                            <div class="aaj-btn-chang-cbtn">
                                                    <button type="submit"  class="aj-btn-a1 btn-fill-lg btn-gradient-dark btn-hover-bluedark">Create Fee Template </button>
                                            </div>
                                        </div>
