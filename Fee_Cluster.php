                ...
                <div class="row justify-content-center mb-4">
                    ...
                    <div class="col-xl-6 col-lg-6 col-12 mb-3">
                        <div class="form-group aj-form-group">
                            ...
                            <select class="select2 col-12" name="fee_stream">
...
<div class="col-xl-12 col-lg-12 col-12 aj-mb-2">
    <div class="Attendance-staff  aj-scroll-Attendance-staff">
        <div class="table-responsive" style="height: 40vh; overflow:scroll;">
            <table class="table-striped display_data">
            </table>
        </div>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        function get_cluster_list() {
            ...
            $.getJSON(ulr, function(data) {
                $.each(data, function(key, value) {
                    html_data += '<tr><td style="width: 30%;">' + value.FG_Name + '</td><td style="width: 15%;">' + value.Class_Name + '</td><td style="width: 15%;">' + value.Stream + '</td><td style="width: 15%;">' + value.Student_Type + '</td><td style="width: 30%;">' + value.school_name + '</td><td style="width: 5%"><button class="btn btn-danger del_cluster" id="' + value.FGCL_Id + '"><i class="fa fa-trash" aria-hidden="true"></i></button></td></tr>';
                });
