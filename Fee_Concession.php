                                                ...
                                                <div class="table-responsive">
                                                    <table class="table display ">
                                                        ...
                                                        <tbody class="top-position-ss">
                                                            <tr>
                                                                <td style="width: 60%;">Admission Fee</td>
                                                                <td style="width: 40%;">
                                                                <div class="form-group aj-form-group">
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%;">Tuition Fee </td>
                                                                <td style="width: 40%;">
                                                                <div class="form-group aj-form-group">
                                                                    <input type="text" name="" placeholder="" class="form-control">
                                                                </div>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%;">Computer Fee</td>
                                                                <td style="width: 40%;">
                                                                <div class="form-group aj-form-group">
                                                                    <input type="text" name="" placeholder="" class="form-control">
                                                                </div>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%;">Biology Lab  Fee</td>
                                                                <td style="width: 40%;">
                                                                <div class="form-group aj-form-group">
                                                                    <input type="text" name="" placeholder="" class="form-control">
                                                                </div>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%;">Physices Lab</td>
                                                                <td style="width: 40%;">
                                                                <div class="form-group aj-form-group">
                                                                    <input type="text" name="" placeholder="" class="form-control">
                                                                </div>
