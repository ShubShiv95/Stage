<?php
$pageTitle = "New Admission Enquiry";
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-12 ">
            <div class="form-group aj-form-group">
                ...
                <input type="text" id="fdate" name="fdate" placeholder="dd/mm/yyyy" class="form-control air-datepicker future-date" data-position='bottom right' required>
