                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="new-added-form aj-new-added-form">
                                                        <div class="aaj-btn-chang-cbtn">
                                                            ...
                                                            if($period==1 ){ echo '<a class="aj-btn-a1 btn-fill-lg btn-gradient-dark  btn-hover-bluedark" href="StudentAttendanceSendSMS.php?&Attendance_Id='.$AttendanceId.'">SEND SMS </a>';}?>
                                                        </div>
                                                    </div>       
                                        </div>                                    
                                    </form>
