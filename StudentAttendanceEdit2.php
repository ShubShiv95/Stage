                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="atten-chack">
                                                        <div class="chack">
                                                            ...
                                                            <label class=""><?php echo '<input type="checkbox" class="form-check-input" ' .  ($period>1 ? 'disabled':'') . '>';?> Send Modified Attendance SMS</label>                                                        </div>
                                                        <div class="chack">
                                                            <label class="form-check-label"><input type="checkbox" class="form-check-input" disabled> Send Modified WhatsApp Attendance Message</label>
                                                        </div>
                                                    </div>
                                                    <div class="new-added-form aj-new-added-form">
                                                        <div class="aaj-btn-chang-cbtn">
                                                            ...
                                                            if($period==1 ){ echo '<a class="aj-btn-a1 btn-fill-lg btn-gradient-dark  btn-hover-bluedark" href="StudentAttendanceMsgPost.php?&aid='.$AttendanceId.'&flag=EDITED">SEND SMS </a>';}?>
                                                        </div>
                                                    </div>       
                                        </div>                                    
                                    </form>
