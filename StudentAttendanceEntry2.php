                        ...
                        <form class="new-added-form school-form aj-new-added-form">
                            <div class="tebal-promotion" >
                                ...
                                <?php
                                  ...
                                  $query1="insert into attendance_master_table (attendance_id,class_id,class_sec_id,doa,period,attendance_taken_by,total_absent,total_present,total_halfday,total_late,school_id) values($aid," .$classid . "," .$secid . ",str_to_date('" . $adt . "','%d/%m/%Y')," . $_REQUEST["period"] . ",'" . $_SESSION["LOGINID"] . "'," . $_REQUEST["absentno"] . "," .$_REQUEST["presentno"] ."," . $_REQUEST["halfdayno"] . "," .$_REQUEST["lateno"] ."," . $_SESSION["SCHOOLID"] . ")";
                                  echo $query1.'<br>';
                                  ...
                                  {
                                  /*	
                                  $query2="select attendance_id from attendance_master_table where class_id=" . $classid . " and class_sec_id=" . $secid . " and school_id=". $_SESSION["SCHOOLID"] . " order by created_on desc limit 1";
                                  //echo $query2;
                                  $result2=$dbhandle->query($query2);
                                  //var_dump($result2);
                                  $row2=$result2->fetch_assoc();
                                  $aid=$row2["attendance_id"];
                                  ...
                                  */
                                  ...
                                  //$query3= "select student_id from student_master_table where class_sec_id=" . $_SESSION["SECID"] . " and enabled=1 and school_id=". $_SESSION["SCHOOLID"];
                                  //echo $query3;
