...
<div class="tab-content">
    ...
    <div class="tab-pane container fade" id="menu1">
        ...
        <div class="row">
            ...
            <div class="col-lg-9" style="height: 40vh; overflow:auto; scroll:auto">
                <div class="content-fild row">
                    <div class="fild-row left col-12 mt-3 border">
                        <div class="name">Name : <span class="content first_name">Ajay</span></div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function show_fee_details(student_id){
           ...
           const fee_url = "./FeeCollectionAPI.php?Parameter=ViewFeeSummary&studentid="+student_id+"&ac_type=SchoolBusFee&school_id="<?php echo $_SESSION['SCHOOLID'] ?>"&session="<?php echo $_SESSION['SESSION'] ?>"";
           var html_fee_row = '';
            $.getJSON(fee_url, function(fee_response){
               html_fee_row += `<tr>`; 
                ...
                html_fee_row += `</tr>` ; 
                html_fee_row += `<tr>`; 
                //console.log(fee_response.Bus_Fee);
