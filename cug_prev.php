                        ...
                        <form class="new-added-form" action="test.php">
                            <div class="row">
                                ...
                                <div class="snap-area-visitor col-xl-6 col-lg-6 col-12 comm-messaage-send-section">
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <div class="tabular-section-detail groupsmsfirsttable comm-message 1st-tab-section">
                                                ...
                                                <table class="table display data-table text-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="form-check-input" value="Test 1 Nursery" name="groupsms">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <div class="tabular-section-detail groupsmssecondtable comm-message 2nd-tab-section">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group groupsmssubmit-btn-sec">
                                        <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark create">Create</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script>    
     $('#L1-Select').on('change', function(){
    	...
    	if(demovalue ==1){
             ...
             document.getElementById("L3-Select").required = true;
            ...
            document.getElementById("L3-Select").required = false;
            $('#unknownNo-div').hide();
            $('#Select-level4-subdiv1').show();
        ...
        $(".get-values").click(function(){
			...
			$.each($("input[name='groupsms']:checked"), function(){
			   ...
			   $dontmove = 0;
				...
				checkAll($(this).val());
               	if($dontmove != 1)	{		
				$('.groupsmssecondtable table tbody').append('<tr><td><div class="form-check"><input type="checkbox" class="" value="'+$(this).val()+'" name="groupsmsact"><label class="form-check-label">'+$(this).val()+'</label></div></td></tr>');
