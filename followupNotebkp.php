                ...
                <div class="card height-auto">
                    <div class="card-body bg-skyblue">
                       <!-- <div class="heading-layout1">
                        ...
                        <?php
                            $query="select * from admission_enquiry_table where AEID=" . $_REQUEST["aeid"];
                    ...
                    <div class="followupnote-sec">
							...
							<div class="col-6-xxxl col-xl-6 col-lg-6 col-12 section">
								 ...
								 <div class="col-6-xxxl col-xl-6 col-lg-6 col-12 element">
                                 <?php echo $result_row["LOCALITY_ID"];?>
								 </div>
								 <div class="col-6-xxxl col-xl-6 col-lg-6 col-12 element">
								...
								<div class="row gutters-8">
								   <div class="col-12-xxxl col-xl-12 col-lg-12 col-12 form-group">
                                    <label>Enter Followup Note</label>
									 <textarea class="textarea form-control"id="followupnote" name="followupnote"  cols="10" rows="4"></textarea>
                                   </div>
									...
									<div class="col-6-xxxl col-xl-6 col-lg-6 col-12 form-group">
										...
										<select class="select2" id="enqtstatus" name="enqtstatus">
