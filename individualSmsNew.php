                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div class="item-title aj-item-title f-aj-item-title">
                                <h3 class="mb-4">Create Close User Group</h3>
                            </div>
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-12 aj-mb-2">
                                    <div class="form-group aj-form-group">
                                        <label>Group Name</label>
                                        <input type="text" name="sd_school_details" placeholder="Enter Group Name" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-12 aj-mb-2">
                                    <div class="form-group aj-form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="main-form-data-communication col-xl-6 col-lg-6 col-12">
                                    <!--Destination Contact List Table -->
                                    <div class="col-xl-12 col-lg-12 col-12 tabular-section-detail" id="Select-level4-subdiv1">
                            ...
                            <div class="row">
                                <div class="main-form-data-communication col-xl-1 col-lg-1 col-12">
                                </div>
                                <div class="main-form-data-communication col-xl-1 col-lg-1 col-12">
                                </div>
                                <div class="main-form-data-communication col-xl-1 col-lg-1 col-12">
